...
class Telaah_awal extends Userpage_Controller {
  ...
  {
    $data['title'] = APPNAME.' - Telaah Awal Protokol';
    $data['page_header'] = 'Daftar Telaah Awal Protokol';
    $data['breadcrumb'] = 'Telaah Awal Protokol';
  ...
  {
    $data['title'] = APPNAME.' - Telaah Awal Protokol';
    $data['page_header'] = 'Form Telaah Awal Protokol';
    $data['breadcrumb'] = 'Telaah Awal Protokol';
